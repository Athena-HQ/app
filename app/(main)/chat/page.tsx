...
function ChatContent() {
  ...
  // Switch tab if a new DM is requested, or persist changes
  useEffect(() => {
    if (typeof window !== "undefined") {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] border rounded-xl overflow-hidden bg-background shadow-sm">
      ...
      >
        <DmHandler newDmUserId={newDmUserId} />
...
function DmHandler({ newDmUserId }: { newDmUserId: string | null }) {
  ...
  }, [newDmUserId, client, user, router, setActiveChannel]);
